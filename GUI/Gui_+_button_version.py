...
class MainApp(tk.Tk):
    ...
    def create_plus_page(self):
        ...
        question_label = tk.Label(plus_frame, text="Möchtest du einen neues Gerät hinzufügen?")
        ...
        tk.Button(plus_frame, text="nein", command=self.show_KompressorIPT_Entluefter).pack(pady=5, padx=10,
                                                                                            side=tk.LEFT)
    ...
    def create_kompressor_ipt_page(self):
        ...
        tk.Button(kompressor_ipt_frame, text="Kompressor", command=self.show_KompressorIPT_Kompressor).pack(pady=5,
                                                                                                            padx=10,
                                                                                                            side=tk.LEFT)
        tk.Button(kompressor_ipt_frame, text="Entluefter", command=self.show_KompressorIPT_Entluefter).pack(pady=5,
                                                                                                            padx=10,
                                                                                                            side=tk.LEFT)
        tk.Button(kompressor_ipt_frame, text="Kuehler", command=self.show_KompressorIPT_Kuehler).pack(pady=5, padx=10,
                                                                                                      side=tk.LEFT)
        tk.Button(kompressor_ipt_frame, text="Gesamt", command=self.show_KompressorIPT_Gesamt).pack(pady=5, padx=10,
                                                                                                    side=tk.LEFT)
        tk.Button(kompressor_ipt_frame, text="Historische Daten",
                  command=self.show_KompressorIPT_HistorischeDaten).pack(pady=5, padx=10, side=tk.LEFT)
    ...
    def create_kompressor_ostfalia_page(self):
        ...
        tk.Button(kompressor_ostfalia_frame, text="Historische Daten",
                  command=self.show_KompressorOstfalia_HistorischeDaten).pack(
            pady=5, padx=10, side=tk.LEFT)
    ...
    def show_KompressorIPT_Kompressor(self):
        ...
        tk.Button(kompressordatenIPT_frame, text="Energie", command=self.plot_KompressorIPT_Kompressor_Energie).pack(
            pady=5,
            padx=10,
            side=tk.LEFT)
