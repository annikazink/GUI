...
temp_button = tk.Button(
    main_frame, text="Systemtemperatur", command=show_temperature, height=2, width=20
)
temp_button.pack(padx=20, pady=10)

pressure_button = tk.Button(
    main_frame, text="Systemdruck", command=show_pressure, height=2, width=20
)
...
close_button = tk.Button(
    root, text="X", command=close_app, bg="red", fg="white", font=("Arial", 12), width=2
)
